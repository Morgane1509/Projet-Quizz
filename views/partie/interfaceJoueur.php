<div class="container m-2 p-2 w-75 h-100 border border-primary rounded" style="font-size: 15pt;">
    ...
    <div class="my-4">
        <button class="btn float-left utile2 rounded shadow text-white font-weight-bold px-2" style="font-size: 13pt;" disabled="disabled">Précédent</button>
        <button class="btn float-right utile3 rounded shadow text-white font-weight-bold px-4 active" style="font-size: 13pt;">Suivant</button>
